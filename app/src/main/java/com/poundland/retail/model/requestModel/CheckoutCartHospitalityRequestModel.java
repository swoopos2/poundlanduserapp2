...
public class CheckoutCartHospitalityRequestModel {
    ...
    public CheckoutCartHospitalityRequestModel(String reservation_id, String payment_gatway, String cardNumber, String cardExpiryMonth,
                                               String cardExpiryYear, String cardCVV, String merchant_id, String venue_id,
                                               String source_type, String payment_mode, String card_id, String order_date,
                                               String user_addr_id, int total_items, double amt_without_tax_discount,
                                               double total_discount, double total_tax, String net_amount, String delivery_charge,
                                               double loyelty_used_amount, String is_gift, int reorder_status, String delivery_type,
                                               String till_id, String staff_id, String transaction_charge_amt,
                                               String transaction_charge, String active_post_code, String active_address_1,
                                               String active_address_2, String active_city, boolean issave, String shipping_ids,
                                               int is_hospitality, String app_type, String service_charge, String tip_amt,
                                               String table_no, String expected_delivery_date, List<ProductsBean> products, String message,
                                               String coupon_code,String coupon_amt) {
    ...
    public static class ProductsBean {
        ...
        public ProductsBean(int product_qty, int product_id, String modifier_id, String delivery_address, String billing_address,
                            ...
                            double discount_applied, long offer_id, double tax_applied, int tax_id, String included_tax, String net_amount,
                            String item_status, String delivery_type, int return_day, int special_offer_id, int case_qty,
                            String bulk_sale_price, String add_on, String tax_type, String allergens, String item_message) {
