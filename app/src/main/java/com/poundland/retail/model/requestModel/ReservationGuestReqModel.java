...
public class ReservationGuestReqModel {
    ...
    public ReservationGuestReqModel(String reservation_id, String customer_email, String customer_name, String slot_id, int is_smoking, String message_for_venue, List<GuestBean> guest) {
