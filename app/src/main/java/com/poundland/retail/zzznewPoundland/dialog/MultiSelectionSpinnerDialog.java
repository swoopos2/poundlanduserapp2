...
public class MultiSelectionSpinnerDialog extends Dialog implements OnMultiSelectionListener {
    ...
    public static Dialog multiSelectionSpinnerDialog;
    private List<String> chosenList = new ArrayList<>();
    public static MultiSpinner multiSpinner;

    public void setMultiSelectionAdapterWithImage(final Context context, List<String> imageURLList, List<String> spinnerContentList,
    ...
    public void setMultiSelectionAdapterWithOutImage(final Context context, List<String> spinnerContentList,
                                              OnMultiSpinnerSelectionListener onMultiSpinnerSelectionListener) {
