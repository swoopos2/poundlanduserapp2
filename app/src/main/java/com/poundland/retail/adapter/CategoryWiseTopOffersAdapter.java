...
public class CategoryWiseTopOffersAdapter extends RecyclerView.Adapter<CategoryWiseTopOffersAdapter.ViewResource> {
    ...
    public CategoryWiseTopOffersAdapter(Context mContext, List<ProductByCategoryResponseModel.ProductsOffersBean> topOfferList, DrawerListner drawerListner) {
    ...
    @NonNull
    @Override
    public CategoryWiseTopOffersAdapter.ViewResource onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_cell_home_top_offers, parent, false);

        return new CategoryWiseTopOffersAdapter.ViewResource(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final CategoryWiseTopOffersAdapter.ViewResource holder, int position) {
        ...
        // holder.binding.tvOffers.setText(topOfferList.get(position).getVenue_name());
    ...
    public int getItemCount() {
        return topOfferList == null ? 0 : topOfferList.size();
    }
    ...
    private void likeDislike(ViewResource holder, final int pos, int merchant_id, String venue_id, int product_id, int modifier_id, int offer_id, String new_price, String couponCode) {
