...
import com.poundland.retail.databinding.ActivityTermConditionBinding;
...
public class TermConditionActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void getIntentData() {
        ...
        if (type.equals("Tc")) {
            binding.tvTitle.setText(getString(R.string.term_condition));
            binding.tvNext.setText(getString(R.string.term_condition));
        } else {
            binding.tvTitle.setText(type);
            binding.tvNext.setText(type);
        }
    ...
    private void getStaticContent(final String contentType) {
        if (isInternetOn(this)) {
            ...
            Call<AboutResponseModel> call = apiInterface.getAboutUs(contentType);
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (staticResponseBean != null) {
                                if (staticResponseBean.isStatus()) {
                                    binding.tvContent.setText(Html.fromHtml(staticResponseBean.getTerm()));

                                } else {
                                    showSnackBar(binding.getRoot(), staticResponseBean.getMessage());
                                }
                            }
