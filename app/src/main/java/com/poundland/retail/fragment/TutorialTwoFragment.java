...
import com.poundland.retail.databinding.FragmentTutorialTwoBinding;

import static com.poundland.retail.interfaces.Constants.AUTH_TOKEN;

public class TutorialTwoFragment extends Fragment{
    private FragmentTutorialTwoBinding binding;
    ...
    private void init() {
        ...
        binding.tvClickNCollect.setText(" Order For Same"+"\n"+" Day Delivery ");
        binding.text.setText(" Get your order delivered "+"\n"+"the very same day "+"\n \n"+"*T&Cs Apply");
