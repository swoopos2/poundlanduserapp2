...
public class PermissionsUtil {
    ...
    public static String LOCATION_FINE = Manifest.permission.ACCESS_FINE_LOCATION;
    public static String LOCATION_COURSE = Manifest.permission.ACCESS_FINE_LOCATION;
    ...
    public static void onRequestPermissionsResult(final int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) context, permission)) {
                ...
                else if (permission.equals(LOCATION_FINE))
